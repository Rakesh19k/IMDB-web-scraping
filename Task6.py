...
def get_movie_list_details(movie_url):
	...
	rank = soup.find("div", class_="article highlighted")
	rank_no = rank.find("strong").a.get_text().strip()
	Rank = rank_no[25:]
	...
	movie_details_dic = {"Name":"","Runtime":"","Gener":"","Bio":"","Director":"","Country":"","Language":"","Date":"","Poster_link":"","Rank":""}
...
def analyse_movie_language():
	...
	Language_dic={"Hindi":"", "English":"", "Malayalam":"", "Tamil":"", "Bengali":"", "Telugu":"", "Other":""}
	Language_dic["Hindi"] = hindi
	Language_dic["English"] = english
	Language_dic["Malayalam"] = malyalam
	Language_dic["Tamil"] = tamil
	Language_dic["Bengali"] = bengali
	Language_dic["Telugu"] = telugu
	return Language_dic
...
# pprint.pprint(analyse_movie_language())
pprint.pprint(movie_scrap_list)
